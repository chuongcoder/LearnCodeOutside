            ...
            <div class="content">
              <article class="home_icon">
                    <a href="./" class="navbar__icon menu-icon">
                        <img src="./img/icon.png" alt="" class="home-img">
                    </a>
                    <span>
                        ...
                        <li class="icon-action user-icon">
                            ...
                            <ul class="dropdown-item">
                                <article class="dropdown-item__top">
                                    <img class="img-user" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyKpQUy8JP90MAZxFjU0P9bPqkUWL35fd8Ag&s" alt="">
                                    <span>Name user</span>
                                </article>
                                <li class="item">
                                    <a href="#">
