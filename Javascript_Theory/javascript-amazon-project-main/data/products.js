...
// convert object into product class
...
export function loadProductsFetch() {
  const promise = fetch('https://supersimplebackend.dev/products').then((response) => {
    // return a promise  (data products = response.json() = productsData)
...
export function loadProducts(fun) {
  ...
  // ket thuc loop map -> da nhan data product backend 
  console.log('load products');

  // sau khi nhan dc data tu backend -> goi ham render page amazon (tham so la ham render page amazon)
  fun();
  })
